...
run.pl ${lda_vec_dir}/log/lda.log \
  ...
  "ark:ivector-normalize-length scp:${lda_vec_dir}/xvector.scp ark:- |" \
...
run.pl $scores_dir/log/lda_scoring.log \
  ...
  "ark:ivector-transform ${lda_vec_dir}/transform.mat scp:${enroll_vec_dir}/spk_xvector.scp ark:- | ivector-normalize-length ark:- ark:- |" \
  "ark:ivector-normalize-length scp:${test_vec_dir}/xvector.scp ark:- | ivector-transform ${lda_vec_dir}/transform.mat ark:- ark:- | ivector-normalize-length ark:- ark:- |" \
